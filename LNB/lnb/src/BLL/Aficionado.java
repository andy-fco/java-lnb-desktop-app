...
public class Aficionado extends Usuario implements Encriptador, Juegos {
	...
	public boolean asignarQuinteto(Jugador j1, Jugador j2, Jugador j3, Jugador j4, Jugador j5) {
		boolean flag = false;
		LinkedList<Jugador> quinteto = new LinkedList<Jugador>();
		...
		if (DLLAficionado.elegirQuinteto(quinteto, this)) {
			this.setQuintetoIdeal(quinteto);
			flag = true;
		}
