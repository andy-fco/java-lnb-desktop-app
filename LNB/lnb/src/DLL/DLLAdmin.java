...
public class DLLAdmin {
	...
	public static boolean agregarAficionado(Aficionado aficionado) {
		...
		try {
			PreparedStatement stmt = con.prepareStatement(
					"INSERT INTO aficionados ( nombre, apellido, id_usuario, pass, email, d_of_birth, puntos) VALUES (?,?,?,?,?,?,?)");
	...
	// EDITAR ADMIN
	public static boolean editarAdmin(Admin admin, String id_viejo) {
		boolean flag = false;
		try {
			PreparedStatement statement = con.prepareStatement(
					"UPDATE administradores SET nombre = ?, apellido = ?, id_usuario = ?, pass = ? WHERE id_usuario = ?");
	...
	// ELIMINAR ADMIN
	public static boolean eliminarAdmin(Admin admin) {
		boolean flag = false;
		String id = admin.getId();

		try {
			PreparedStatement statement = con.prepareStatement("DELETE FROM administradores WHERE id_usuario = ?");
