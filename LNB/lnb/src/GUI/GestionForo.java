		...
		btnEditar_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (eventoSeleccionado != null) {
					JTextField tituloField = new JTextField(eventoSeleccionado.getTitulo());
					JTextField fechaField = new JTextField();
					JTextField horaField = new JTextField();
					JSpinner capSpinner = new JSpinner(new SpinnerNumberModel(eventoSeleccionado.getCapMax(),1,1000,1));
					JTextArea descArea = new JTextArea(10, 40);  
					descArea.setLineWrap(true);
					descArea.setWrapStyleWord(true);
					JScrollPane descScroll = new JScrollPane(descArea);
					descArea.setText(eventoSeleccionado.getDescripcion());
					
					String fecha = eventoSeleccionado.getFechaYHora().toLocalDate().toString();  

				 
					String hora = eventoSeleccionado.getFechaYHora().toLocalTime().format(DateTimeFormatter.ofPattern("HH:mm"));  
					...
					if (option == JOptionPane.OK_OPTION) {
						...
						try {
						    ...
						    if (DLLEvento.editarEvento(nuevoEvento, eventoSeleccionado.getTitulo())) {
						        JOptionPane.showMessageDialog(null, "Evento editado correctamente");
						        cargarTablaEventos(); 
						        eventoSeleccionado = null;
						        lblSeleccionado.setText("");
						    } else {
						        JOptionPane.showMessageDialog(null, "Hubo un error al editar el evento, por favor intentalo más tarde");
						    }
